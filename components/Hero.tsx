...
const Hero = () => {
    return(
        ...
        <div className="pb-20 pt-36">
         ...
         bg-background dark:bg-black-100 dark:bg-grid-white/[0.05] 
         bg-grid-black/[0.2] absolute top-0 left-0">
      <div
        className={cn(
          "absolute inset-0",
    ...
    <div className="flex justify-center relative
        ...
        <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] 
            ...
            <h2 className="uppercase tracking-widest 
                ...
                words="Transforming Concepts into Seamlesss User Experience"
                />
                ...
                <p className="text-center md:tracking-wider 
                                ...
                                lg:text-2xl">
                    Hi, I&apos;m Abdulkarim a Next.js Developer based in China
                </p>
